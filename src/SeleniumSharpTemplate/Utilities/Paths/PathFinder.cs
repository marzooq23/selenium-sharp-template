...
public class PathFinder
{
    ...
    public const string CONFIG_DIRECTORY = "Tests\\Configuration";
    public const string EXECUTORS_DIRECTORY = "Utilities\\Executors";
    public const string BROWSER_SETTINGS_DIRECTORY = "Utilities\\WebDrivers\\BrowserOptions";
